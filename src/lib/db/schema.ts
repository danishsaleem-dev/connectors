...
/** A brand's saved locations — the star icon on /portal/locations. Owned by
 * the organization (not the individual user) since anyone signed into that
 * brand's account should see the same saved list. */
